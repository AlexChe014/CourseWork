...
namespace CourseWork2
{
    class TeacherForm
    {
        ...
        public TeacherForm()
        { }
        public void AddTeacher(DateTimePicker dateTimePicker, System.Windows.Forms.CheckBox checkBox1)
        {
        ...
        public void EditTeacher(users item, users result, string name, string surname,
            string patron, DateTime date, string old_pass, string new_pass, bool check, bool check2)
        {
            if (date > DateTime.Now) throw new Exception("Эта дата еще не наступила");
            if (check)
            {
